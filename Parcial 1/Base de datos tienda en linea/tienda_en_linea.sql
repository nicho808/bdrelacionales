...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 13, 2025 at 01:06 AM
...
(1, 'ropa', 'asriculos de ropa variados y de todo tipo');
...
(1, 'Boulevard canata', 2977, 'canata', 80085, 'sinaloa', 'culiacan', 1);
...
--
-- Dumping data for table `lista_de_deseos`
--
...
(1, 'pantalones cargo negros', 'pantalones de cargo color negro unisex tallas disponibles', 399, 1, 1);
...
(1, 'Paolo', 'Valdez', 'peanutznico@gmail.com', '6675412714', '2008-10-30', 1);
...
--
-- Dumping data for table `usuarios_membresia`
--
